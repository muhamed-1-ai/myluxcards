...
const INITIAL_LEAD_STAGES: StageConfigItem[] = [
  ...
  },
  {
    ...
    isClosed: true,
    active: true,
    substages: [{ id: "sub-9", name: "Order Created" }],
  ...
  },
  {
    ...
    isClosed: true,
    active: true,
    substages: [{ id: "sub-10", name: "Reason Logged" }],
...
export function LeadStagesConfig() {
  ...
  const handleSaveStage = (e: React.FormEvent) => {
    ...
    const trimmedShort = formData.shortForm.trim().toUpperCase().replaceAll(/[^A-Z0-9]/g, "").slice(0, 10);
    if (!trimmedShort) {
