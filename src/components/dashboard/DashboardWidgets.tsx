  ...
  return (
    <div className="crm-kpi-grid" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))" }}>
      <div className="crm-kpi-card" style={{ borderColor: "rgba(38,119,223,0.3)" }}>
        ...
        <div className="crm-kpi-value text-white">{analytics?.totalOpens ?? 0}</div>
        <div className="crm-kpi-sub">Total card views</div>
      </div>

      <div className="crm-kpi-card" style={{ borderColor: "rgba(0, 229, 255,0.3)" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
      ...
      <div className="crm-kpi-card" style={{ borderColor: "rgba(46,204,113,0.3)" }}>
        ...
        <div className="crm-kpi-value text-emerald-400">{unreadReplies}</div>
      ...
      <div className="crm-kpi-card" style={{ borderColor: "rgba(230,126,34,0.3)" }}>
        ...
        <div className="crm-kpi-value text-orange-400">{followUps}</div>
      ...
      <div className="crm-kpi-card" style={{ borderColor: "rgba(155,89,182,0.3)" }}>
        ...
        <div className="crm-kpi-value text-purple-400">{wonLeads}</div>
...
export function DigitalCardKpiGrid({
  ...
  return (
    <div className="crm-kpi-grid" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))" }}>
      <div className="crm-kpi-card" style={{ borderColor: "rgba(0, 229, 255,0.35)" }}>
...
export function CompactTodayCard({
  ...
  return (
    <div style={{ background: "#0B0C10", border: "1px solid rgba(0, 229, 255, 0.35)", borderRadius: 16, padding: 20, marginBottom: 20 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(120px, 1fr))", gap: 12 }}>
        <div style={{ background: "#12131A", borderRadius: 12, padding: 14, border: "1px solid rgba(255,255,255,0.06)" }}>
          <div style={{ fontSize: 24, fontWeight: 800, color: "#FFF" }}>{analytics?.totalOpens ?? 0}</div>
          <div style={{ fontSize: 11, color: "#888", marginTop: 2 }}>Profile Opens</div>
        </div>

        <div style={{ background: "#12131A", borderRadius: 12, padding: 14, border: "1px solid rgba(52,152,219,0.2)" }}>
        ...
        <div style={{ background: "#12131A", borderRadius: 12, padding: 14, border: "1px solid rgba(46,204,113,0.2)" }}>
        ...
        <div style={{ background: "#12131A", borderRadius: 12, padding: 14, border: "1px solid rgba(155,89,182,0.2)" }}>
    ...
    <div style={{ background: "#0B0C10", border: "1px solid rgba(255, 255, 255, 0.1)", borderRadius: 16, padding: 18, marginBottom: 20 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <span style={{ fontSize: 10, background: "rgba(0, 229, 255, 0.2)", color: "#0066FF", border: "1px solid rgba(0, 229, 255, 0.4)", padding: "1px 7px", borderRadius: 10, fontWeight: 700 }}>
            {items.length} Pending
          </span>
        </div>
        <span style={{ fontSize: 12, color: "#888" }}>Action Required</span>
      </div>
        ...
        {items.map((item) => (
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              {item.icon}
              <span style={{ fontSize: 13, color: "#FFF", fontWeight: 600 }}>{item.text}</span>
            </div>
...
export function PerformanceAnalyticsWidget({
  ...
  return (
    <div style={{ background: "#0B0C10", border: "1px solid rgba(255, 255, 255, 0.1)", borderRadius: 16, padding: 20, marginBottom: 20 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
        <div>
          <span style={{ fontSize: 11, fontWeight: 800, color: "#0066FF", letterSpacing: "0.06em", textTransform: "uppercase" }}>
            PROFILE PERFORMANCE
          </span>
          <h3 style={{ fontSize: 16, fontWeight: 700, color: "#FFF", margin: "2px 0 0" }}>Visitor Entry Breakdown</h3>
        </div>

        <div style={{ display: "flex", gap: 4, background: "#14151B", padding: 3, borderRadius: 10, border: "1px solid rgba(255,255,255,0.08)" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 14 }}>
        <div style={{ background: "#12131A", borderRadius: 12, padding: 14, border: "1px solid rgba(46,204,113,0.2)" }}>
          <div style={{ fontSize: 12, color: "#888" }}>NFC Taps</div>
          ...
          <div style={{ fontSize: 10.5, color: "#666", marginTop: 4 }}>{nfcPct}% of total entries</div>
        </div>

        <div style={{ background: "#12131A", borderRadius: 12, padding: 14, border: "1px solid rgba(52,152,219,0.2)" }}>
          <div style={{ fontSize: 12, color: "#888" }}>QR Scans</div>
          ...
          <div style={{ fontSize: 10.5, color: "#666", marginTop: 4 }}>{qrPct}% of total entries</div>
        </div>

        <div style={{ background: "#12131A", borderRadius: 12, padding: 14, border: "1px solid rgba(155,89,182,0.2)" }}>
          <div style={{ fontSize: 12, color: "#888" }}>Direct / Unknown</div>
          ...
          <div style={{ fontSize: 10.5, color: "#666", marginTop: 4 }}>{otherPct}% of total entries</div>
        </div>
      </div>
    </div>
  );
    ...
    <div style={{ background: "#0B0C10", border: "1px solid rgba(255, 255, 255, 0.1)", borderRadius: 16, padding: 20, marginBottom: 20 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
        <div>
          ...
          <h3 style={{ fontSize: 16, fontWeight: 700, color: "#FFF", margin: "2px 0 0" }}>
      ...
      <div style={{ width: "100%", height: 6, background: "rgba(255,255,255,0.08)", borderRadius: 3, overflow: "hidden", marginBottom: 14 }}>
        <div style={{ width: `${pct}%`, height: "100%", background: "#0066FF", transition: "width 0.3s ease" }} />
      </div>

      {missingItems.length > 0 ? (
        <div>
          <div style={{ fontSize: 11.5, color: "#888", marginBottom: 8, fontWeight: 600 }}>
...
export function ActiveCardBanner({
  ...
  return (
    <div style={{ background: "#0D0E15", border: "1px solid rgba(0, 229, 255, 0.35)", borderRadius: 16, padding: 20, marginBottom: 20, display: "flex", flexWrap: "wrap", justifyContent: "space-between", alignItems: "center", gap: 16 }}>
      <div>
        <span style={{ fontSize: 11, fontWeight: 800, color: "#0066FF", letterSpacing: "0.06em", textTransform: "uppercase" }}>
          PUBLISHED DIGITAL CARD
        </span>
        <h2 style={{ fontSize: 20, fontWeight: 800, color: "#FFF", margin: "2px 0 2px" }}>{card.name}</h2>
        <p style={{ fontSize: 13, color: "#888", margin: 0 }}>{card.title} {card.business ? `· ${card.business}` : ""}</p>
      </div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }}>
        <button
          ...
          style={{ fontSize: 12, padding: "8px 14px", background: "rgba(0, 229, 255,0.15)", color: "#0066FF", borderColor: "rgba(0, 229, 255,0.3)" }}
        >
          View Profile
        </button>
        ...
        <button
          ...
          onClick={() => onNavigateTab("contact")}
          className="crm-pill-btn"
          style={{ fontSize: 12, padding: "8px 14px", background: "#14151B", color: "#FFF", borderColor: "rgba(255,255,255,0.15)" }}
        >
          Edit Card
        </button>
      </div>
...
export function QuickActionsGrid({
  ...
  const actions = [
    { label: "View Profile", icon: <ExternalLink className="w-4 h-4 text-blue-400" />, onClick: onOpenCardPreview },
